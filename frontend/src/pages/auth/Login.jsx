...
const loginBoxColors = {
  student:
    "bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-blue-800/20",
  staff:
    "bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100 dark:from-emerald-900/20 dark:via-teal-900/20 dark:to-emerald-800/20",
  hr: "bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 dark:from-rose-900/20 dark:via-pink-900/20 dark:to-rose-800/20",
  admin:
    "bg-gradient-to-br from-purple-50 via-violet-50 to-purple-100 dark:from-purple-900/20 dark:via-violet-900/20 dark:to-purple-800/20",
};

const roleImages = {
  student:
    "https://img.freepik.com/premium-photo/graduation-boy-girl-class-room_1036975-32053.jpg",
  staff:
    "https://img.freepik.com/premium-photo/portrait-professional-workers-office-attire-isolated-white-background-3d-cartoon-animation_36897-54576.jpg?w=1060",
  ...
  admin:
    "https://img.freepik.com/premium-psd/businessman-with-documents-pointing-glasses-3d-isolated-transparent-background-png-psd_1130573-121202.jpg",
};
...
export default function Login() {
    ...
    if (oauthError) {
      const oauthErrorMessages = {
        ...
        token_exchange_failed:
          "Google token exchange failed. Check OAuth client secret and redirect URI.",
        missing_access_token:
          "Google token response did not include an access token.",
        profile_fetch_failed: "Unable to fetch Google profile details.",
        invalid_profile:
          "Google profile is missing required fields (email or id).",
      ...
      const detailMessage = oauthErrorDetail
  ...
  const handleForgotPasswordRequest = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        setForgotStep("reset");
        const otpInfo = response.data.devOtp
          ? ` OTP: ${response.data.devOtp}`
          : "";
        setForgotMessage(
          `${response.data.message || "OTP sent to your email."}${otpInfo}`,
        );
      } else {
  ...
  const confirmOAuthLogin = async (userData) => {
    ...
    try {
      ...
      if (response.data.otpRequired) {
        ...
        setErrorMsg(
          response.data.message || "OAuth login failed. Please try again.",
        );
      }
    } catch (error) {
      setErrorMsg(
  ...
  const handleOtpVerify = async (e) => {
    ...
    setOtpError("");
    try {
      const response = await oauthAPI.verifyOtp({
        email: otpEmail,
        otp: otpInput,
      });
  ...
  return (
    ...
    >
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Generative AI Placement System is dedicated to bridging the gap
                between talented students and leading employers. We empower
                institutions with cutting-edge placement management solutions
                powered by AI that drive success and career growth.
              </p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Successfully placed over 5,000+ students across 500+ leading
                organizations with a 94% placement rate in 2025.
              </p>
            </div>
          </div>
        </InfoModal>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 dark:bg-slate-700 p-4 rounded-lg">
                ...
                <p className="text-3xl font-black text-blue-700 dark:text-yellow-300 drop-shadow-lg mt-2">
                  5,000+
                </p>
              </div>
              <div className="bg-emerald-50 dark:bg-slate-700 p-4 rounded-lg">
                ...
                <p className="text-3xl font-black text-emerald-700 dark:text-yellow-300 drop-shadow-lg mt-2">
                  94%
                </p>
              </div>
              <div className="bg-rose-50 dark:bg-slate-700 p-4 rounded-lg">
                ...
                <p className="text-3xl font-black text-rose-700 dark:text-yellow-300 drop-shadow-lg mt-2">
                  500+
                </p>
              </div>
              <div className="bg-purple-50 dark:bg-slate-700 p-4 rounded-lg">
                ...
                <p className="text-3xl font-black text-purple-700 dark:text-yellow-300 drop-shadow-lg mt-2">
                  8.5 LPA
                </p>
              </div>
            </div>
      ...
      {activeModal === "contact" && (
        <InfoModal title="Contact Support" onClose={() => setActiveModal(null)}>
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  +91-6302004848 <br /> Available: Mon-Fri, 9 AM - 6 PM IST
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ashwithareddykavvam@gmail.com <br /> Response time: Within 2
                  hours
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Generative AI Placement System HQ <br /> komally, Hyderabad,
                  India - 500100
                </p>
              </div>
            </div>
            <div className="bg-blue-50 dark:bg-slate-700 p-4 rounded-lg border border-blue-200 dark:border-slate-600">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Monday - Friday: 9:00 AM - 6:00 PM IST <br /> Saturday: 10:00 AM
                - 4:00 PM IST <br /> Sunday: Closed
              </p>
            </div>
          </div>
        </InfoModal>
          ...
          <div className="space-y-6">
            ...
            {moreSection === "overview" && (
              <div className="space-y-3">
                <h4 className="text-lg font-semibold text-gray-900 dark:text-yellow-200">
                  Platform Highlights
                </h4>
                <p className="text-sm text-gray-700 dark:text-yellow-100">
                  The platform supports end-to-end placement workflows,
                  including job posting, profile screening, interview
                  scheduling, and offer tracking for students, staff, HR, and
                  admin users.
                </p>
            ...
            {moreSection === "success" && (
              <div className="space-y-3">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <p className="font-semibold text-gray-800 dark:text-yellow-100">
                    "Secured a software role in my first interview cycle."
                  </p>
                  <p className="text-sm text-gray-600 dark:text-yellow-100">
                    - Rahul Sharma, CSE 2025
                  </p>
                </div>
                <div className="border-l-4 border-emerald-500 pl-4">
                  <p className="font-semibold text-gray-800 dark:text-yellow-100">
                    "The mock interview flow helped me crack technical rounds."
                  </p>
                  <p className="text-sm text-gray-600 dark:text-yellow-100">
                    - Priya Patel, ECE 2024
                  </p>
                </div>
                <div className="border-l-4 border-rose-500 pl-4">
                  <p className="font-semibold text-gray-800 dark:text-yellow-100">
                    "I received multiple offers and picked the best fit."
                  </p>
                  <p className="text-sm text-gray-600 dark:text-yellow-100">
                    - Arjun Singh, IT 2025
                  </p>
            ...
            {moreSection === "recruiters" && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-700 dark:text-yellow-100">
                  Hiring partners include product companies, service
                  organizations, and startups across software, analytics,
                  consulting, and core engineering roles.
                </p>
                <ul className="text-sm space-y-2 text-gray-700 dark:text-yellow-100">
                  <li>• 500+ active recruiters with verified openings</li>
                  <li>• Structured hiring pipelines for campus drives</li>
                  <li>
                    • Dedicated HR coordination for interview slots and offers
                  </li>
                </ul>
              </div>
            )}
            ...
            {moreSection === "privacy" && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-700 dark:text-yellow-100">
                  Personal data is used only for placement operations, candidate
                  communication, and reporting. Access is role-restricted and
                  protected through secure authentication controls.
                </p>
                <ul className="text-sm space-y-2 text-gray-700 dark:text-yellow-100">
                  <li>• No unauthorized sharing of candidate information</li>
                  <li>
                    • Encrypted credential handling and protected sessions
                  </li>
                  <li>
                    • Audit-friendly logs for critical recruitment actions
                  </li>
                </ul>
              </div>
            )}
        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <div className="group relative cursor-pointer flex items-center gap-1 text-slate-800 dark:text-slate-100">
              <span className="font-bold text-blue-700 dark:text-yellow-300 drop-shadow-lg">
                More
              </span>{" "}
              <ChevronDown size={14} />
              <div
              ...
              >
                <div className="p-2 space-y-1">
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-white dark:text-blue-300 font-bold hover:bg-blue-600 dark:hover:bg-blue-400 rounded-lg"
        ...
        >
          <div
            className={`w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center transition-all duration-700 ${
              darkMode ? "bg-slate-900/80" : "bg-slate-900/70"
            }`}
          >
            ...
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-sm uppercase font-semibold text-gray-900 dark:text-blue-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <label
                  className="block text-xs font-semibold mb-2 text-white"
                  style={{ textShadow: "0 1px 4px #000" }}
                >
                  Select Role
                </label>
              ...
              <div className="relative my-6">
                <div className="absolute inset-0 flex items-center">
                  <div
                    className={`w-full h-px ${darkMode ? "bg-slate-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div
                  className={`relative flex justify-center text-sm ${darkMode ? "bg-slate-900" : "bg-white"}`}
                >
                  <span
                    className={`px-2 ${darkMode ? "text-slate-200" : "text-gray-700"}`}
                  >
                    Or continue with
                  </span>
                </div>
            ...
            <p
              className="mt-5 text-sm text-center text-white font-bold"
              style={{ textShadow: "0 1px 4px #000" }}
            >
              Don't have an account?
              <Link
                to="/register"
                className="text-blue-400 ml-1 font-bold hover:underline"
                style={{ textShadow: "0 1px 4px #000" }}
              >
                Register Now
              </Link>
            ...
            <div className="relative z-10 text-center w-full flex flex-col items-center gap-6">
              ...
              <div className="text-white">
                ...
                <p className="mt-4 text-sm opacity-90 max-w-xs mx-auto">
                  Welcome to Generative AI Placement System. Your success is our
                  mission.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold text-white ${
                    pendingOAuth.provider === "Google"
                      ? "bg-red-500"
                      : pendingOAuth.provider === "LinkedIn"
                        ? "bg-blue-600"
                        : "bg-gray-800"
                  }`}
                >
                ...
                <div>
                  <h3 className="text-lg font-bold">
                    Login with {pendingOAuth.provider}
                  </h3>
                  <p
      ...
      {otpModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div
            className={`w-full max-w-md rounded-3xl overflow-hidden shadow-2xl transition-all ${darkMode ? "bg-slate-800 text-white" : "bg-white text-gray-800"}`}
          >
            <div
              className={`p-8 flex flex-col gap-6 border-b ${darkMode ? "border-slate-700 bg-slate-800" : "border-gray-100 bg-white"}`}
            >
              <h3 className="text-lg font-bold mb-2">Enter OTP</h3>
              <p className="text-sm mb-2">
                An OTP has been sent to{" "}
                <span className="font-semibold">{otpEmail}</span>. Please enter
                it below to complete login.
              </p>
      ...
      {forgotModal && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            <div
              className={`p-8 flex flex-col gap-5 border-b ${darkMode ? "border-slate-700 bg-slate-800" : "border-gray-100 bg-white"}`}
            >
              <h3 className="text-lg font-bold">
                {forgotStep === "request"
                  ? "Forgot Password"
              ...
              {forgotStep === "request" ? (
                ...
                >
                  ...
                  />
                  {forgotMessage && (
                    <p className="text-sm text-amber-500">{forgotMessage}</p>
                  )}
                  <div className="flex gap-3 pt-2">
                    <button
                      type="button"
      ...
      >
        &copy; 2026 Generative AI Placement System. Designed for Institutional
        Excellence.
      </footer>
    </div>
  );
